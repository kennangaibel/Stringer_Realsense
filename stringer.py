...
import copy
import math
# Coordinates can be converted from 2D pixel coordinates to 3D world coordinates by first aligning the depth stream
# to the color stream with the align_to instruction and then 'deprojecting' 2D to 3D using the instruction
