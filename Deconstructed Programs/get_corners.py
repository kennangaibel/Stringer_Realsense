...
# Loads image and runs opencv corner detection software
...
# !: ADD DEPTH FILTER HERE
# Prints out pixel coordinates of all detected corners

# !!: PROBLEM IS THAT BAG FILE IS IN 640, 480 RESOLUTION
# !!: NEED TO SOMEHOW CONVERT OR GET IT IN THE SAME RESOLUTION
# Solutionn: Divide the pixel value, so 1920 / 640 = 3
for i in range(1, len(corners)):
    ...
    # print(x_pixel)
    # print(y_pixel)
    # If the corner is too far away, don't include it
